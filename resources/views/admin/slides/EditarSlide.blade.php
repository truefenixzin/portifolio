        ...
        <div class="card">
            ...
            <div class="card-body mx-auto">
                ...
                <div class="form-group">
                    <form action="{{route('admin.slides.update', $slide    ->id)}}" method="post" autocomplete="off"
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="date" class="form-control" name="dtini"
                                               value="{{\Carbon\Carbon::parse($slide->dtini)->format('Y-m-d')}}">
                                    </div>
                                    <div class="col-6">
                                        <label for="dtfim">Data Fim:</label>
                                        <input type="date" class="form-control" name="dtfim"
                                               value="{{\Carbon\Carbon::parse($slide->dtfim)->format('Y-m-d')}}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
